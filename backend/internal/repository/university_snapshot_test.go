...
func setupUniversityRepo(t *testing.T) *UniversityRepository {
	t.Helper()
	...
	return NewUniversityRepository(db)
}

func TestUniversityListByIdsSnapshotStableP402(t *testing.T) {
	repo := setupUniversityRepo(t)
...
func TestUniversityRepoListSnapshotStableP404(t *testing.T) {
	repo := setupUniversityRepo(t)
